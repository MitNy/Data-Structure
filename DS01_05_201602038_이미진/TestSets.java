...
public class TestSets {
	public static void main(String[] args) {
		// 정수 범위 n을 입력받았을 때, 각각의 집합은 하나의 원소 만을 포함하는 상태로 초기화.
		int n = 8;
		...
		sets.addSet(set0); sets.addSet(set1);
		sets.addSet(set2); sets.addSet(set3);
		sets.addSet(set4); sets.addSet(set5);
		sets.addSet(set6); sets.addSet(set7);
